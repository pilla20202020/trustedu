                            ...
                            <div class="card">
                                ...
                                <div class="card-body tab-content">
                                    <div class="tab-pane active" id="first2">
                                        ...
                                        <div class="form-group">
                                            {{ Form::label('setting[videolink_1]', 'Video Link 1') }}
                                            {{ Form::text('setting[videolink_1]', old('setting.videolink_1') ?: setting('videolink_1'), ['class'=>'form-control','rows'=>2]) }}
                                        </div>

                                        <div class="form-group">
                                            {{ Form::label('setting[videolink_2]', 'Video Link 2') }}
                                            {{ Form::text('setting[videolink_2]', old('setting.videolink_2') ?: setting('videolink_2'), ['class'=>'form-control','rows'=>2]) }}
                                        </div>
                                        <div class="form-group">
