                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                value="{{ old('name', isset($whysweden->name) ? $whysweden->name : '') }}" placeholder="Enter a Title" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" rows="4">{{ old('description', isset($whysweden->description) ? $whysweden->description : '') }}
                                </textarea>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                value="{{ old('link', isset($whysweden->link) ? $whysweden->link : '') }}" placeholder="Enter a Link">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row d-flex align-items-end">.
                        ...
                        <div class="col-sm-6">
                            ...
                            @if(isset($whysweden) && isset($whysweden->image))
                                <img id="holder" style="margin-top:15px;max-height:300px;" class="img img-fluid mb-3" src="{{$whysweden->image}}">
                            @endif
                            <div class="d-flex">
                                <input id="thumbnail" class="form-control" type="text" name="image" value="{{ old('image', isset($whysweden->image) ? $whysweden->image : '') }}" readonly>
                    ...
                    <div class="row mt-2 justify-content-center">
                        <div class="form-group">
                            <div>
                                <a class="btn btn-light waves-effect ml-1" href="{{ route('why-sweden.index') }}">
