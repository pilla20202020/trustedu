            ...
            <div class="card-underline">
                ...
                <div class="card-body">
                        ...
                        <div class="col-sm-12">
                            {{-- <div class="form-group">
                                <input type="text" name="name" class="form-control" required
                                       value="{{ old('name', isset($agent->name) ? $agent->name : '') }}"/>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="">
                                    <input class="form-control" type="text" required name="name" value="{{ old('name', isset($agent->name) ? $agent->name : '') }}" placeholder="Enter Your Name">
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <div class="">
                                    ...
                                    value="{{ old('email', isset($agent->email) ? $agent->email : '') }}" placeholder="Enter a email" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <div class="">
                                    ...
                                    value="{{ old('phone', isset($agent->phone) ? $agent->phone : '') }}" placeholder="Enter a Phone" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-2 justify-content-center">
                        <div class="form-group">
                            <div>
                                <a class="btn btn-light waves-effect ml-1" href="{{ route('agent.index') }}">
