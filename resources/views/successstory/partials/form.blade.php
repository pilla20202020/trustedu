                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <label for="checklist_for" class="col-form-label pt-0">Title</label>
                            <div class="form-group">
                                <input class="form-control" type="text" name="name" data-role="tagsinput"
                                value="{{ old('name', isset($successstory->name) ? $successstory->name : '') }}" placeholder="Enter a Title" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" rows="4">{{ old('description', isset($successstory->description) ? $successstory->description : '') }}
                                </textarea>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                value="{{ old('link', isset($successstory->link) ? $successstory->link : '') }}" placeholder="Enter a Link">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row d-flex align-items-end">.
                        ...
                        <div class="col-sm-6">
                            ...
                            @if(isset($successstory) && isset($successstory->image))
                                <img id="holder" style="margin-top:15px;max-height:300px;" class="img img-fluid mb-3" src="{{$successstory->image}}">
                            @endif
                            <div class="d-flex">
                                <input id="thumbnail" class="form-control" type="text" name="image" value="{{ old('image', isset($successstory->image) ? $successstory->image : '') }}" readonly>
                    ...
                    <div class="row mt-2 justify-content-center">
                        <div class="form-group">
                            <div>
                                <a class="btn btn-light waves-effect ml-1" href="{{ route('successstory.index') }}">
