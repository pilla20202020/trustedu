            ...
            <div class="card-underline">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                value="{{ old('name', isset($testimonial->name) ? $testimonial->name : '') }}" placeholder="Enter a Name" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" rows="4">{{ old('description', isset($testimonial->description) ? $testimonial->description : '') }}
                                </textarea>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                value="{{ old('link', isset($testimonial->link) ? $testimonial->link : '') }}" placeholder="Enter a Link">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row d-flex align-items-end">.
                        ...
                        <div class="col-sm-6">
                            ...
                            @if(isset($testimonial) && isset($testimonial->image))
                                <img id="holder" style="margin-top:15px;max-height:300px;" class="img img-fluid mb-3" src="{{$testimonial->image}}">
                            @endif
                            <div class="d-flex">
                                <input id="thumbnail" class="form-control" type="text" name="image" value="{{ old('image', isset($testimonial->image) ? $testimonial->image : '') }}" readonly>
                    ...
                    <div class="row mt-2 justify-content-center">
                        <div class="form-group">
                            <div>
                                <a class="btn btn-light waves-effect ml-1" href="{{ route('testimonial.index') }}">
